...
int main(int argc, char ** argv)
{
	...
	Py_Initialize();
	if ( ! Py_IsInitialized()){
		printf(" Something went wrong in inititalization\n");
	}
	...
	if( ! PyRun_AnyFile(fp,"example/e1.py"))
		printf("something went wrong in running the code\n");
